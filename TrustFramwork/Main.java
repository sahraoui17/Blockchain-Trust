...
public class Main {
    ...
    //this to intilize the first block and choose at least one PoS entity to start the trust system runing
   /* public static Block intilizeBlockchain(Blockchain BC,int blockSize){
   ...
   /* public static void add_rating(Transaction t){
        
    } */
    
    public void updatePoS(ArrayList PoS,Entity e,double PoSthreshold){
